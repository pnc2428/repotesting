...
sap.ui.define([
	...
	"zrepotest/zrepotest/test/flpSandbox"
	...
	return Opa5.extend("zrepotest.zrepotest.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "ZCDS_D96_TEST/" + encodeURIComponent(sObjectId);

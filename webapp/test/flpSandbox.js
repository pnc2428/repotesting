			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zrepotest-display": {
								"semanticObject": "zrepotest",
								"action": "display",
								"description": "zrepotest",
								"title": "zrepotest",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zrepotest.zrepotest",
									"url": sap.ui.require.toUrl("zrepotest/zrepotest")
								}
							}
						}
					}
